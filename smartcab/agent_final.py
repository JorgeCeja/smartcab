...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.trials += 1
            self.epsilon = math.pow(self.const, self.trials)
            self.test *= self.alpha
            print "Epsilon now : " + str(self.epsilon)
            print "Epsilon now : " + str(self.test)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            self.Q[state][action] = (
                1.0 - self.alpha) * self.Q[state][action] + self.alpha * reward
